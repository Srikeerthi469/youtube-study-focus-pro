...
- **Scripting & Storage APIs**: Vanilla JavaScript (ES6+), Chrome Storage API, Chrome Alarms API

## 📦 Local Installation Guide
Want to run this project locally on your machine? Follow these steps:
1. Download or clone this repository as a `.zip` file and extract it.
